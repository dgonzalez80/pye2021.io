...
|:--------------|:-----------------------------|
| Actividad202    | Actividad202.pdf : Solucionario taller 202. Cada uno de los integrantes debe subir a la plataforma el resultado del trabajo en formato pdf | 
...
```{r}
# install.packages("titanic")  # instalacion paquete con datos
library(titanic)               #  cargar paquete titanic
library(tidyverse)             #  cargar  paquete manejo de datos

data("Titanic_train")          # cargar datos
